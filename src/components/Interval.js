...
export default function Interval () {
  return (
    <div className="project" id="interval">
      <p>This is a node package that can be used in music theory apps to determine musical intervals. I could not find an equivalent node package, so I made an easy one that is easy to find and use. There are strict rules associated with naming notes, so it was a challenge to make sure that any valid note entered returns the correct note and any invalid input throw a helpful error. This app was built with Node.js and tested with Jest.</p>
